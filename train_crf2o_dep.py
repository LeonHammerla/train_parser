...
from parsers.dep import CRF2oDependencyParser
...
def main():
    ...
    #subparser.add_argument('--train', default='/home/stud_homes/s5935481/work3/treebanks/UD_German-GSD/de_gsd-ud-train.conllu', help='path to train file')
    #subparser.add_argument('--dev', default='/home/stud_homes/s5935481/work3/treebanks/UD_German-GSD/de_gsd-ud-dev.conllu', help='path to dev file')
    #subparser.add_argument('--test', default='/home/stud_homes/s5935481/work3/treebanks/UD_German-GSD/de_gsd-ud-test.conllu', help='path to test file')
    # =====================

    subparser.add_argument('--embed', default='/home/stud_homes/s5935481/work3/data/embeddings/lemma_kom.txt', help='path to pretrained embeddings')
    ...
    # =====================
    subparser.add_argument('--data', default='/home/stud_homes/s5935481/work3/data/de_hdt-ud-test.conllu', help='path to dataset')

    # subparser.add_argument('--data', default='/home/stud_homes/s5935481/work3/treebanks/UD_German-GSD/de_gsd-ud-test.conllu', help='path to dataset')
    # =====================
    # predict
