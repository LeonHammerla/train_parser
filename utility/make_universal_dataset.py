...
conll18_dir = '/home/stud_homes/s5935481/work3/treebanks/'
unilang_dir = '/home/stud_homes/s5935481/work3/treebanks/UD_English-ParTUT'
os.makedirs(unilang_dir, exist_ok=True)

with codecs.open(os.path.join(unilang_dir, 'en_partut-ud-train.conllu'), 'w') as unitrain_conllu,\
     codecs.open(os.path.join(unilang_dir, 'en_partut-ud-train.txt'), 'w') as unitrain_txt,\
     codecs.open(os.path.join(unilang_dir, 'en_partut-ud-dev.conllu'), 'w') as unidev_conllu,\
     codecs.open(os.path.join(unilang_dir, 'en_partut-ud-dev.txt'), 'w') as unidev_txt:
